...
# Replace: move static cards OUT of dynamicBlog into staticBlog, and make dynamicBlog empty
old_block = '''                <div id="dynamicBlog" class="grid-3 reveal">
...
new_block = '''                <div id="staticBlog" class="grid-3 reveal">
                    <div class="card blog-card">
                        <div class="blog-img">
                            <img src="./assets/images/metaverse1.jpg" alt="Metaverse">
                        </div>
                ...
                <div id="dynamicBlog" class="grid-3 reveal"></div>'''

if old_block in content:
    content = content.replace(old_block, new_block, 1)
    print("Replaced successfully!")
else:
    print("Block NOT found - need to debug")
