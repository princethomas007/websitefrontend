...
if (document.getElementById("dynamicPortfolio")) {

    fetch("https://rextech-django-production.up.railway.app")
        .then(res => res.json())
        .then(data => {

            const container = document.getElementById("dynamicPortfolio");

            data.forEach(item => {

                container.innerHTML += `<a class="arvr-showcase-card" href="#">
                    <div class="arvr-showcase-left">
                        <div class="arvr-showcase-title">${item.title}</div>

                        <div class="arvr-showcase-divider"></div>

                        <ul class="arvr-showcase-points">
                            <li>${item.category}</li>
                            <li>${item.description}</li>
                        </ul>
                    </div>

                    <div class="arvr-showcase-right">
                        <img src="https://rextech-django-production.up.railway.app${item.image}" alt="${item.title}">
                    </div>
                </a>`
                ;
...
if (document.getElementById("dynamicBlog")) {

    fetch("https://rextech-django-production.up.railway.app")
        .then(response => response.json())
        .then(data => {
            console.log(data);
            const container = document.getElementById("dynamicBlog");
            ...
            data.forEach(item => {
                ...
                container.innerHTML += 
                    `<div class="card blog-card">
                        <div class="blog-img">
                         <img
                         src="https://rextech-django-production.up.railway.app${item.image}"
                         alt="${item.title}"
